...
param(
    ...
    [ValidateSet('All', 'adr-cycle', 'design-team', 'design-to-html', 'goal-cycle', 'restart-safe-handoff', 'runtime-incident-investigator', 'supervised-session-conductor')]
    [string]$Skill = 'All',
...
function Get-SelectedSkills {
    ...
    if ($Selection -eq 'All') { return @('adr-cycle', 'design-team', 'design-to-html', 'goal-cycle', 'restart-safe-handoff', 'runtime-incident-investigator', 'supervised-session-conductor') }
    return @($Selection)
}
...
function Get-RestorePlan {
    ...
    if ([string]$transaction.selection -notin @('All', 'adr-cycle', 'design-team', 'design-to-html', 'goal-cycle', 'restart-safe-handoff', 'runtime-incident-investigator', 'supervised-session-conductor')) { throw 'Transaction selection is invalid' }
    ...
    foreach ($item in @($transaction.items)) {
        ...
        if ($skillName -notin @('adr-cycle', 'design-team', 'design-to-html', 'goal-cycle', 'restart-safe-handoff', 'runtime-incident-investigator', 'supervised-session-conductor')) { $errors += "Unsupported transaction skill:$skillName"; continue }
